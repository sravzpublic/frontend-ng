...
export const environment = {
  ...
  GOOGLE_CLIENT_KEY: '31329435502-pjlpea38gv9cjp6599hr51gt2vf1k7t4.apps.googleusercontent.com',
  FACEBOOK_APP_ID: '991696984600301',
  TWITTER_APP_ID: 'Q1ktZThQc3llNTY3dktWNjk4TUE6MTpjaQ',
  LINKEDIN_APP_ID: '775qt148agm2gz',
  BACKEND_GO_URL: 'https://analyticslocal.sravz.com',
  HUGO_URL: 'https://docs.sravz.com/',
  apiUrl: 'https://portfoliolocal.sravz.com/api',
  BACKEND_NODE_URL: 'https://portfoliolocal.sravz.com',
  ...
  DATA_SERVICE_BASE : 'https://portfoliolocal.sravz.com',
  PORTFOLIO_SERVICE_BASE : 'https://portfoliolocal.sravz.com',
  ANALYTICS_SERVICE_BASE : 'https://analyticslocal.sravz.com',
  QUOTES_SERVICE_BASE : 'https://quoteslocal.sravz.com',
  ANALYTICS_SOCKET_SERVICE_BASE : 'wss://analyticslocal.sravz.com',
