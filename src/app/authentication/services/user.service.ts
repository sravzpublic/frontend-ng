...
export class UserService {
  ...
  public get isGuest(): boolean {
    ...
    return (user?.username === 'guest123') || (user?.email === 'guest123@guest.com');
  }
  ...
  public get initials(): string {
    ...
    if (this.currentUser.given_name) {
      initials += this.currentUser.given_name.substr(0, 1);
    }
  ...
  /** Save new login as current user - Used to set the user details in the local storage **/
